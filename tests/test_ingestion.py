...
@patch("src.ingestion._check_duplicate")
def test_ingestion_smoke(mock_dup, mock_meta, mock_parse, mock_embed, mock_supabase) -> None:
    # Setup mocks
    mock_parse.return_value = "This is a dummy PDF text."
    mock_meta.return_value = {"company_name": "TestCompany", "document_version": "v1"}
