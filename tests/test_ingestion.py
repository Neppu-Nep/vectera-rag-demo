...
@patch("src.ingestion.register_discovered_companies")
@patch("src.ingestion.embed_texts")
@patch("src.ingestion.enrich_chunk")
@patch("src.ingestion.document_parser.reducto_parse_financial_pdf")
@patch("src.ingestion.extract_metadata")
@patch("src.ingestion.check_duplicate")
def test_ingestion_smoke(
    mock_dup,
    mock_meta,
    mock_parse,
    mock_enrich,
    ...
    mock_enrich.return_value = {
        "enriched_text": "Enriched chunk",
        "mentioned_companies": ["TestCompany"],
    }
